...
namespace ParkingLot.Services
{
    ...
    {
        public static string? NearestSlot(this ParkingOperations parking, VechicleType type)
        {
        ...
        public static void CreatingTicket(this ParkingOperations parking,VechicleType type, string slotID)
        {
        ...
        public static void ParkVehicle(this ParkingOperations parking)
        {
